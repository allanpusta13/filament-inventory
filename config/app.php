...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These are the service providers that will be loaded on your application.
    | Laravel ships with a number of providers by default. You are free to add
    | more providers to this array as your application grows and requires more
    | services.
    |
    */
    ...
    | starts. However, feel free to register as many as you wish. The aliases
    | allow you to access some of Laravel's classes without typing out the
