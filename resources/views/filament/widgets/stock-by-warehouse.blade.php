<x-filament-widgets::widget>
    <x-filament::section heading="Warehouse Inventory Summary">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            @forelse ($warehouses as $warehouse)
                <div class="fi-card relative flex flex-col overflow-hidden rounded-lg bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 p-6 transition-colors duration-150 hover:bg-gray-50 dark:hover:bg-white/[0.04] focus-within:ring-2 focus-within:ring-primary-500/25 focus-visible:outline-none">
