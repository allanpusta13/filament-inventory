...
return new class() extends Migration
{
    public function up(): void
    {
        Schema::create('stock_movements', function (Blueprint $table) {
            ...
            $table->string('unit_name_used');      // Packaging format label used during the transaction
            ...
            // Polymorphic source — string to support both bigint and UUID/ULID-keyed models
